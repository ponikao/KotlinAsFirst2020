...
fun trackLength(x1: Double, y1: Double, x2: Double, y2: Double): Double {
    fun differenceSqr(a: Double, b: Double): Double = (a - b) * (a - b)
    val sum: Double = differenceSqr(x2, x1) + differenceSqr(y2, y1)
    return sqrt(sum)
}
...
fun travelMinutes(hoursDepart: Int, minutesDepart: Int, hoursArrive: Int, minutesArrive: Int): Int {
    val minutes: Int = 60 - minutesDepart + minutesArrive
    val hours: Int = (hoursArrive - hoursDepart - 1) * 60
