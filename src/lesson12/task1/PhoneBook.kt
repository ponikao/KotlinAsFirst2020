...
class PhoneBook {
    ...
    val bookOfPhones = mutableMapOf<String, MutableSet<String>>()
     ...
     */
    fun addHuman(name: String): Boolean = bookOfPhones.putIfAbsent(name, mutableSetOf()) == null
     ...
     * (во втором случае телефонная книга не должна меняться).
     */
    fun removeHuman(name: String): Boolean = bookOfPhones.remove(name) != null
    ...
    fun addPhone(name: String, phone: String): Boolean {
        val phoneByName = bookOfPhones[name]
        if (phoneByName == null || humanByPhone(phone) != null) return false
    ...
    fun removePhone(name: String, phone: String): Boolean =
        bookOfPhones[name]?.remove(phone) ?: false

    /**
     * Вернуть все номера телефона заданного человека.
     * Если этого человека нет в книге, вернуть пустой список
     */
    fun phones(name: String): Set<String> = bookOfPhones[name] ?: emptySet()
    ...
    fun humanByPhone(phone: String): String? {
        for ((name, phones) in bookOfPhones) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return this.bookOfPhones == other.bookOfPhones
    }
